...
function editNotes(id, name) {
  ...
  async function initEditor() {
    if (!window.tinymce) {
      const url = "https://HittyGubby.github.io/Hearts-of-FMG-IV/libs/tinymce/tinymce.min.js";
      try {
        await import(url);
      } catch (error) {
    ...
    if (window.tinymce) {
      window.tinymce._setBaseUrl("https://HittyGubby.github.io/Hearts-of-FMG-IV/libs/tinymce");
      tinymce.init({
        license_key: "gpl",
